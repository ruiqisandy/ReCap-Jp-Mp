 ...
 * It will scrape chat conversations from chat.openai.com
 *
 * Planned Features:
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  if (message.type === 'startScraping' && message.platform === 'chatgpt') {
    console.log('[ChatGPT Scraper] Scraping requested - will be implemented in Module 2');
    sendResponse({ success: false, message: 'Module 2 not yet implemented' });
  }
  return true;
});

console.log('[ChatGPT Scraper] Ready for Module 2 implementation');
