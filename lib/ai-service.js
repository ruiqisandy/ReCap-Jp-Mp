...
`;
      ...
      console.log(`[AI Service] Mind map prompt length: ${prompt.length} chars`);
      ...
      try {
        ...
        console.log(`[AI Service] Successfully parsed ${mindmapData.mindmap.length} top-level topics`);
      ...
      console.log(`[AI Service] Mind map HTML generated: ${bulletPointsHTML.length} chars`);
